...
7. `~/.claude/cursor-bridge/Performance-Conventions.md` and `Performance-Patterns.md` (projects with performance or cost budgets)
8. Every `SKILL.md` under `~/.claude/skills/`
